...
namespace TicariOtomasyon.Controllers
{
    public class IstatistikController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.d4 = deger4;
            var deger5 = c.Uruns.Sum(x => x.Stok);
            ViewBag.d5 = deger5;
            ...
            ViewBag.d12 = deger12;
            var deger13 = c.SatisHarekets.GroupBy(x=>x.Urun.UrunAdi).OrderByDescending(z=>z.Count()).Select(y=>y.Key).FirstOrDefault();
            ViewBag.d13 = deger13;
        ...
        public ActionResult SimpleTables() {
            ...
            { Sehir = g.Key, Sayi = g.Count()};
            return View(sorgu.ToList()); }

        public PartialViewResult Partical1()
        {
        ...
        public PartialViewResult Partical2()
        {
            var sorgu = c.Carilers.ToList();
            return PartialView(sorgu);
        }
        public PartialViewResult Partical3()
        {
            var sorgu = c.Uruns.ToList();
            return PartialView(sorgu);
        }
        public PartialViewResult Partical4()
        {
